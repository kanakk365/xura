...
const HERO_STATS: HeroStat[] = [
  ...
  { figure: "UL 9540A", label: "Certified" },
  { figure: "24/7", label: "Monitoring" },
];

export function StrategyHero() {
  return (
    <section className="relative isolate flex min-h-[90svh] w-full flex-col overflow-hidden bg-ink grain">
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1400px] flex-1 flex-col items-center justify-center mt-26 px-5 py-10 text-center sm:px-10 sm:py-14 lg:px-16">
        ...
        >
          ...
          <span className="text-mute">Xura</span>
        </p>
        ...
        >
          <span className="mx-auto block text-balance text-[clamp(2.5rem,8vw,4.75rem)] font-normal leading-[1.05] sm:max-w-[20ch]">
            An <span className="italic text-accent">execution-first</span>{" "}
            approach to site-level electrification.
          </span>
        </h1>
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="flex items-baseline justify-center gap-1.5">
        <span className="font-display tracking-normal text-[1.7rem] font-normal leading-none text-paper sm:text-4xl lg:text-[2.7rem]">
          {figure}
        </span>
        {suffix && (
