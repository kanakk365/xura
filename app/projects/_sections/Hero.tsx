  ...
  return (
    <section className="relative isolate flex min-h-[88svh] w-full flex-col overflow-hidden bg-ink grain">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1400px] flex-1 flex-col items-center justify-center mt-26 px-5 py-10 text-center sm:px-10 sm:py-14 lg:px-16">
        ...
        >
          <span className="mx-auto block text-balance text-[clamp(2.5rem,8vw,4.75rem)] font-normal leading-[1.05] sm:max-w-[18ch]">
            From constraints to{" "}
            <span className="italic text-accent">execution</span>.
          </span>
        </h1>
        ...
        >
          These examples illustrate how Xura evaluates site constraints, designs
          around grid limitations, and delivers reliable electrification
          solutions for commercial and fleet-driven properties.
        </p>
