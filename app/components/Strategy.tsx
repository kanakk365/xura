...
const PRINCIPLES: Principle[] = [
  {
    ...
    points: [
      "One control layer across all three",
      "Sized as a system, not per component",
    ],
  },
  {
    id: "site-selection",
    ...
    points: [
      "Capacity validated before design",
      "Constructability confirmed on site",
    ],
  },
  {
    id: "operator-led",
    ...
    points: [
      ...
      "No handoff between scope and delivery",
    ],
  },
  {
    id: "performance",
    ...
    points: [
      "Continuous monitoring after handover",
      "Performance measured against design",
    ],
  },
];
...
export function Strategy() {
  return (
    <section id="strategy" className="doc-section">
      <div className="doc-shell">
        <p className="kicker">Strategy</p>

        <h2 className="doc-h2 mt-4 max-w-[24ch]">
          An <span className="text-accent">execution-first</span> approach.
        </h2>

        <p className="doc-lead mt-3.5">
          Built around a simple constraint &mdash; the grid can&rsquo;t expand
          fast enough to meet near-term electrification demand. Four principles
          keep delivery honest.
        </p>

        {/* One bordered block quartered by hairlines, matching the FAQ list. */}
            ...
            <li key={p.id} className="flex flex-col bg-ink-2 p-6 sm:p-8">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="font-mono text-[0.58rem] uppercase tracking-[0.18em] text-mute">
                  Principle {p.number} / {String(PRINCIPLES.length).padStart(2, "0")}
                </span>
              </div>
